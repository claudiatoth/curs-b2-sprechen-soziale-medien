// PDF BUILDER — Sprechen B2 Soziale Medien (Eltern vs. Jugendliche)
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Vocabular Soziale Medien (B2 Sprechen)</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — Vocabular Soziale Medien în context (substantive cheie)', 'Plattformen, Follower, süchtig, Bildschirmzeit, Konzentration, Vergleich, gemeinsame Regeln, Digital-Detox, Privatleben — cuvinte cheie pentru dialog.', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillInBlock('Übung 4 — Dialog Mamă (părinte) ↔ Fiică (adolescent)', 'Dialog tipic inter-generațional B2: mama exprimă îngrijorare, fiica își apără libertatea, ambele găsesc compromis. Vocabular emoțional & negociere matură.', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += fillInBlock('Übung 5 — Expresii pentru rol (PĂRINTE / ADOLESCENT / AMBII)', 'Formule cheie pentru fiecare rol: PĂRINTE — Sorgen, An deiner Stelle. ADOLESCENT — Du verstehst nicht, Freunde, Vertrau mir. AMBII — Kompromiss finden, was hältst du davon, gemeinsam besprechen.', ex5Data);
        }
        return html;
    }
    ...
    function buildFlashcards() {
        ...
        let html = `<h1 class="chapter new-section">📇 3. Vocabular complet (Flashcards)</h1>
            <p style="margin-bottom:10px">Cele <strong>${count} carduri</strong> ale lecției — 5 platforme/acțiuni + 6 PRO adolescent + 8 CONTRA părinte + 5 reguli/limite + 4 soluții/compromis + 4 expresii dialog.</p>
